...
public class StudentRepositoryImpl implements StudentRepository {
    ...
    public Optional<Student> findById(Connection connection,String id){
        //todo#3 학생조회
        String sql = "SELECT id, name, gender, age FROM jdbc_students WHERE id = ?";
        ...
        try(
            ...
            if(resultSet.next()){
                Student student = new Student(resultSet.getString("id"), resultSet.getString("name"), Student.GENDER.valueOf(resultSet.getString("gender")),resultSet.getInt("age"));
